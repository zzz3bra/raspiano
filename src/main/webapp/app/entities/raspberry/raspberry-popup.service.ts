...
@Injectable()
export class RaspberryPopupService {
    ...
    open(component: Component, id?: number | any): NgbModalRef {
        ...
        if (id) {
            ...
            return this.raspberryModalRef(component, new Raspberry());
        }
    }

    raspberryModalRef(component: Component, raspberry: Raspberry): NgbModalRef {
