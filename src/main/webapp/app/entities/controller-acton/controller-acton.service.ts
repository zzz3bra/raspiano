...
@Injectable()
export class ControllerActonService {

    private resourceUrl = 'api/controller-actons';

    constructor(private http: Http, private dateUtils: DateUtils) { }

    create(controllerActon: ControllerActon): Observable<ControllerActon> {
        const copy: ControllerActon = Object.assign({}, controllerActon);
    ...
    update(controllerActon: ControllerActon): Observable<ControllerActon> {
        const copy: ControllerActon = Object.assign({}, controllerActon);
    ...
    find(id: number): Observable<ControllerActon> {
