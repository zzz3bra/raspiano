...
@Component({
    selector: 'jhi-controller-acton',
    templateUrl: './controller-acton.component.html'
})
export class ControllerActonComponent implements OnInit, OnDestroy {
controllerActons: ControllerActon[];
    currentAccount: any;
    ...
    trackId(index: number, item: ControllerActon) {
        return item.id;
    }
